...
def train_gen():
    ...
    with tf.GradientTape() as gen_tape:
        ...
        fake_fx = discriminator_fe(generated_images, False)
        fake_output = discriminator_final(fake_fx, False)
